...
def subscribe_to_advertisements(self):
    ...
    self.bus.add_signal_receiver(
        ...
        dbus_interface='com.victronenergy.ble.Advertisements',  # Interface
...
class VictronMonitor:
    ...
    def check_router(self):
        ...
        try:
            ...
            service = self.bus.get_object('com.victronenergy.ble.advertisements', '/ble_advertisements')
            iface = dbus.Interface(service, 'com.victronenergy.ble.Advertisements')
            version = iface.GetVersion()
...
2. Check correct interface: `com.victronenergy.ble.Advertisements` (capital A)
